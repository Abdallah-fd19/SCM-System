...
const Dashboard = ()=>{
 return(
 <>
  <div className="min-h-screen bg-amber-50 grid grid-rows-2">
   <div className="grid grid-cols-3 m-auto gap-x-15 justify-center items-center">
    <div className="flex flex-col gap-y-8 bg-white w-2xs h-80 rounded-md justify-center items-center relative border-2 border-transparent rounded-tr-none rounded-bl-none hover:border-gray-800 transition-all duration-300">
     ...
     <Link to={"/courses/create"} className="flex justify-center items-center gap-x-6 hover:text-yellow-500 transition-all duration-300">
    ...
    <div className="flex flex-col gap-y-8 bg-white w-2xs h-80 rounded-md justify-center items-center relative border-2 border-transparent rounded-tr-none rounded-bl-none hover:border-gray-800 transition-all duration-300">
     ...
     <Link className="mt-16 flex justify-center items-center gap-x-6 hover:text-gray-500 transition-all duration-300">
      View assignments <MdOutlineRemoveRedEye/>
     </Link>
     <Link className="flex justify-center items-center gap-x-6 hover:text-yellow-500 transition-all duration-300">
   ...
   <div className="grid grid-cols-1 m-auto">
    <div className="bg-red-500 w-3xl h-60">Chart</div>
   </div>
  </div>
 </>
 )
